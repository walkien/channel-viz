(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'EeI392olkULBFboqWVzDk7GzYtvnnVTq3dnvZKcUM4XAle01', // Unique master Xively API key to be used as a default
		defaultFeeds	= [767902846], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Arduino Sensoren', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '63B8FF', // CSS HEX value of color to represent data (omit leading #)
